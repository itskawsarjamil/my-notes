      ...
      <div className="w-full max-w-sm p-6 m-auto mx-auto  rounded-lg shadow-md bg-white-800 text-black">
        <form onSubmit={handleSubmit} className="mt-6">
          <div>
            ...
            <input
              ...
              id="email"
              type="email"
              className="block w-full px-4 py-2 mt-2 font-semibold border rounded-lg  text-black border-gray-600  focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              name="password"
              type="password"
              className="block w-full px-4 py-2 mt-2   border rounded-lg  text-black border-gray-600  focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
            />
          </div>
        ...
        <div className="flex items-center mt-6 -mx-2">
          ...
          >
            ...
            {/* <span onClick={handleGooglelogin} className="hidden mx-2 sm:inline">
              Sign in with Google
            </span> */}
          </button>
