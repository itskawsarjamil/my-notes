const Teams = () => {
  return (
    <section id="teammembers" className="py-6 text-gray-100">
      <div className="container p-4 mx-auto space-y-16 sm:p-10">
        <div className="space-y-4">
          <h3 className="text-2xl text-black  font-bold leading-none sm:text-5xl">
            Meet our team
          </h3>
          <p className="max-2xl text-gray-400  text-center ">
